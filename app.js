...
app.get('/wallet', ensureAuthenticated, UserController.showWallet)
app.post('/wallet/recharge', ensureAuthenticated, UserController.rechargeWallet)
...
app.get('/nets-qr/success', ensureAuthenticated, NetsController.showSuccess)
app.get('/nets-qr/fail', ensureAuthenticated, NetsController.showFail)
app.get('/sse/payment-status/:txnRetrievalRef', ensureAuthenticated, NetsController.streamPaymentStatus)
app.get('/api/nets/payment-status/:txnRetrievalRef', ensureAuthenticated, NetsController.getStatus)
app.get('/checkout/paypal', ensureAuthenticated, PayPalController.showCheckout)
app.post('/api/paypal/create-order', ensureAuthenticated, PayPalController.createOrder)
app.post('/api/paypal/capture-order', ensureAuthenticated, PayPalController.captureOrder)
